...
\todo{Write more about our specific uses of the player controller}
...
\todo{Write more about our specific use the the manager}
...
Er kan op twee manieren logica aan een event gekoppeld worden. De eerste is via het component menu \todo{zie figure x} en de tweede zoals getoond in \todo{figure x2}.

\missingfigure{Screenshot van manier twee.}
